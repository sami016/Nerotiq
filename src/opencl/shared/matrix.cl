 ...
 */
inline int getMatrixIndex(Matrix matrix, uint row, uint column) {
 ...
 */
inline float getMatrixValue(Matrix matrix, uint row, uint column) {
 ...
 */
inline void setMatrixValue(Matrix matrix, uint row, uint column, double value) {
